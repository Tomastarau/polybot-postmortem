...
Switching the bot to simulation mode means editing one line in a file — the next
task to wake up honours it. A long-running loop would have demanded signal
